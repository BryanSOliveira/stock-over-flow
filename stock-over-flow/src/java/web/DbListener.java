...
public class DbListener implements ServletContextListener {
    ...
    public static final String URL = "jdbc:sqlite:stock-17.db";
    ...
    public void contextInitialized(ServletContextEvent sce) {
        try {
            ...
            if(Movement.getMovements().isEmpty()) {
                ...
                Movement.insertMovement(1, "Sistema","Offtrack", "Saida", -5, 100.00, "Saida de produtos no estoque");
            ...
            */
            ...
            if(Movement.getMovements().isEmpty()) {
                ...
                Movement.insertMovement(9, "Sistema","Offtrack", "Saida", -2, 109.92, "Venda");
                ...
                Movement.insertMovement(8, "Sistema","CláraCloth", "Saida", -16, 59.99, "Venda");
                Movement.insertMovement(5, "Sistema","Gucci", "Entrada", 5, 6189.99, "Entrada de produtos");
                Movement.insertMovement(4, "Sistema","r7 Calçados", "Saida", -6, 289.99, "Venda");
                Movement.insertMovement(6, "Sistema","Roupas Brás", "Entrada", 100, 53.97, "Entrada de produtos");
                Movement.insertMovement(3, "Sistema","Gucci", "Saida", -3, 1549.99, "Venda");
                ...
                Movement.insertMovement(1, "Sistema","B F1 Confecções", "Saida", -6, 140.99, "Venda");
                Movement.insertMovement(8, "Sistema","CláraCloth", "Saida", -4, 69.99, "Venda");
                Movement.insertMovement(6, "Sistema","CláraCloth", "Saida", -16, 99.99, "Venda");
                Movement.insertMovement(10, "Sistema","Crocs Market", "Saida", -6, 349.99, "Venda");
                Movement.insertMovement(10, "Sistema","Crocs Market", "Saida", -2, 369.99, "Venda");
                Movement.insertMovement(2, "Sistema","Mario Roupas", "Saida", -3, 299.99, "Venda");
                Movement.insertMovement(5, "Sistema","Gucci", "Saida", -1, 8999.99, "Venda");
                Movement.insertMovement(4, "Sistema","r7 Calçados", "Saida", -4, 349.99, "Venda");
                Movement.insertMovement(1, "Sistema","B F1 Confecções", "Saida", -1, 196.99, "Venda");
                Movement.insertMovement(8, "Sistema","Zara", "Entrada", 3, 149.99, "Devolução");
                Movement.insertMovement(6, "Sistema","Roupas Brás", "Saida", -8, 129.99, "Venda");
                Movement.insertMovement(6, "Sistema","Roupas Brás", "Saida", -13, 149.99, "Venda");
                Movement.insertMovement(4, "Sistema","r7 Calçados", "Entrada", 2, 349.00, "Devolução");
                Movement.insertMovement(7, "Sistema","Roupas Brás", "Saida", -2, 10000.00, "Venda");
                Movement.insertMovement(2, "Sistema","Mario Roupas", "Saida", -3, 269.99, "Venda");
                Movement.insertMovement(2, "Sistema","Mario Roupas", "Saida", -20, 189.93, "Lote defeituoso");
            ...
            if(Provider.getProviders().isEmpty()) {
                ...
                Provider.insertProvider("Gucci", "Av. Anchieta, 5981", "(13) 4567-4222", "gucci.market@gucci.com");
                Provider.insertProvider("Offtrack", "Av. Rio Claro, 5981", "(12) 7865-4092", "offtrack@gmail.com");
